...
> **Yakio-san review note**: This is a sizing/implementation reference, not a service limit. The constraint originates from Apache Spark's Parquet reader, not from FSx S3 AP.
