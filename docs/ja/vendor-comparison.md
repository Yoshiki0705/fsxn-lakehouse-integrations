...
FSx for NetApp ONTAP のエンタープライズストレージを S3 Access Points 経由で
...
|---------|---------|-------------|----------|
| **Databricks** | Unity Catalog External Location / S3 External Table | Delta Lake on FSxN, ML Feature Store | ✅ 実装済み |
