...
|------------|:---:|------------|------------|
| 画像 (JPEG, PNG, TIFF) | ❌ | N/A（構造化テーブルのガバナンスレイヤー） | — |
| 動画 (MP4, MOV) | ❌ | N/A | — |
| ドキュメント (PDF, DOCX) | ❌ | N/A | — |
| 音声 (WAV, MP3) | ❌ | N/A | — |
| バイナリ / アーカイブ | ❌ | N/A | — |

Lake Formation は Glue Data Catalog に登録されたテーブルに対するガバナンスを提供します。非構造化データファイルを直接ガバナンスすることはできませんが、非構造化ファイルを参照するメタデータテーブルにアクセス制御を適用できます。

**非構造化ファイルメタデータのガバナンスパターン:**
