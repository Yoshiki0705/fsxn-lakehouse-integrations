...
URL 's3://4163c10e-279c-43da-twofx9eqndyjcrko43kkrcwjsuedeapn1b--table-s3'
...
OPTIONS (
  authorized_paths = 's3://4163c10e-279c-43da-twofx9eqndyjcrko43kkrcwjsuedeapn1b--table-s3'
);
```

**Result**: ❌ FAILED

**Error**: `[EXTERNAL_LOCATION_DOES_NOT_EXIST] parent external location for path 's3://4163c10e-279c-43da-twofx9eqndyjcrko43kkrcwjsuedeapn1b--table-s3/' does not exist.`
...
- Workspace: `https://dbc-fca81837-d98c.cloud.databricks.com`
