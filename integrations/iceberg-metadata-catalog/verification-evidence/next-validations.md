...
| B-4 | Unity Catalog Foreign Iceberg: S3 Tables direct REST | High | ❌ **Not supported** (2026-06-02): S3 Tables is not supported in Databricks. Tracked via an internal product request. |
