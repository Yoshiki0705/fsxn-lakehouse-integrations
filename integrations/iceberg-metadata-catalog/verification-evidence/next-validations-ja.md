...
| A-4 | S3 Tables direct REST vs Glue Iceberg REST: PyIceberg、Spark、Athena、Lake Formation | 中 | 部分検証済み |
...
| D-4 | 10 万ファイル以上での S3 AP ListObjectsV2 ページネーション | 中 | TBD |
...
| E-2 | LF-Tags 分類体系のデプロイとテスト | 中 | 分類体系定義済み |
