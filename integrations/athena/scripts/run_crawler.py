...
Usage:
    python run_crawler.py [--crawler-name fsxn-athena-crawler-dev] [--wait]
"""
...
def main():
    ...
    params = load_params()
    crawler_name = args.crawler_name or params.get("CrawlerName", "fsxn-athena-crawler-dev")
    database_name = args.database or params.get("DatabaseName", "fsxn_athena_db")
